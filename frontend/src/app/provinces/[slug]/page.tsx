...
const PATTANI_RESTAURANTS: Place[] = [
  ...
  { id: 'r15', name: 'SA-MI-LAE. Cafe\' & Relax Space', rating: 4.3, type: '☕ ร้านกา��ฟ', status: 'เปิดอยู่ · ปิดเวลา 8:00 หลังเที่ยง', description: 'คาเฟ่บรรยากาศสบายๆ ใกล้มหาวิทยาลัย เหมาะสำหรับนักศึกษา', bullets: [], image: 'https://img.wongnai.com/p/624x0/2018/02/20/e43987d7bf3049dc9b4074eed61fa82c.jpg', mapsUrl: 'https://maps.google.com/?q=Samilare' },
