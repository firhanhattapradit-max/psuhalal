...
const NARATHIWAT_RESTAURANTS: Place[] = [
  { id: 'nr_restaurants_0', name: 'สวนอาหารริมน้ำ', description: 'ร้านอาหารฮาลาลบรรยากาศดีติดริมแม่น้ำในตัวเมืองนราธิวาส เหมาะสำหรับการรับประทานอาหารเย็นร่วมกับครอบครัวหรือกรุ๊ปทัวร์ มีเมนูอาหารทะเลสด อาหารไทยพื้นบ้าน และเมนูแกงสไตล์ปักษ์ใต้รสชาติจัดจ้าน', rating: 4.5, type: '🍽️ ร้านอาหาร', image: '/images/places/nr_restaurants_0.jpg' },
  { id: 'nr_restaurants_1', name: 'ร้านอาหารริมน้ำบางปอ', description: 'ร้านอาหารบรรยากาศริมน้ำอีกหนึ่งแห่งที่ให้บริการอาหารฮาลาลรสชาติดั้งเดิม โดดเด่นด้วยอาหารทะเลสดใหม่ อาหารพื้นบ้านภาคใต้ และบรรยากาศที่สบายๆ', rating: 4.5, type: '🍽️ ร้านอาหาร', image: '/images/places/nr_restaurants_1.jpg' },
  { id: 'nr_restaurants_2', name: 'ร้านยะกังโภชนา', description: 'ร้านอาหารมุสลิมเก่าแก่ที่มีชื่อเสียงในย่านยะกัง มีอาหารเช้าและอาหารตามสั่งฮาลาล อาทิ ข้าวยำ โรตี ข้าวหมกไก่ และชาร้อนรสเข้มข้น', rating: 4.6, type: '🍽️ ร้านอาหาร', image: '/images/places/nr_restaurants_2.jpg' },
  { id: 'nr_restaurants_3', name: 'ไก่กอและ', description: 'ร้านอาหารฮาลาลต้นตำหรับไก่กอและบนถนนระแงะมรรคา เสิร์ฟไก่กอและราดซอสเข้มข้น รสชาติหวานมันเผ็ดกำลังดี เหมาะสำหรับมื้อเที่ยง', rating: 4.7, type: '🍽️ ร้านอาหาร', image: '/images/places/nr_restaurants_3.jpg' },
  { id: 'nr_restaurants_4', name: 'AKHOO by Nasir', description: 'ร้านอาหารมุสลิมสมัยใหม่ ตกแต่งสไตล์คาเฟ่ บริการอาหารฮาลาลหลากหลายประเภท ทั้งอาหารไทย อาหารตะวันตก และเครื่องดื่ม', rating: 4.5, type: '🍽️ ร้านอาหาร', image: '/images/places/nr_restaurants_4.jpg' },
  ...
  { id: 'nr_restaurants_6', name: 'November Cafe', description: 'คาเฟ่ฮาลาลบรรยากาศอบอุ่น ให้บริการกาแฟ เครื่องดื่มสมูทตี้ ขนมหวาน และอาหารจานเดียว', rating: 4.3, type: '☕ คาเฟ่', image: '/images/places/nr_restaurants_6.jpg' },
  ...
  { id: 'nr_restaurants_8', name: 'ร้าน Md.', description: 'ร้านอาหารฮาลาลยอดนิยมของคนท้องถิ่น เสิร์ฟอาหารจานเดียวและเมนูทานง่ายรสชาติดั้งเดิม', rating: 4.2, type: '🍽️ ร้านอาหาร', image: '/images/places/nr_restaurants_8.jpg' },
];
...
const NARATHIWAT_ATTRACTIONS: Place[] = [
  ...
  { id: 'nr_attractions_1', name: 'อุทยานแห่งชาติอ่าวมะนาว-เขาตันหยง', description: 'ชายหาดโค้งเว้าสวยงามเงียบสงบ ล้อมรอบด้วยธรรมชาติอันร่มรื่นและโขดหิน มีเส้นทางศึกษาธรรมชาติและพื้นที่สำหรับพักผ่อนหย่อนใจ', rating: 4.5, type: '🏞️ อุทยานแห่งชาติ', image: '/images/places/nr_attractions_1.jpg' },
  { id: 'nr_attractions_2', name: 'มัสยิดวาดีอัลฮูเซ็น (มัสยิด 300 ปี)', description: 'มัสยิดไม้โบราณสถาปัตยกรรมผสมผสานไทย มลายู และจีน สร้างโดยไม่ใช้ตะปู เป็นศูนย์รวมจิตใจและสถานที่ท่องเที่ยวทางประวัติศาสตร์ที่สำคัญในอำเภอบาเจาะ', rating: 4.7, type: '🕌 มัสยิด', image: '/images/places/nr_attractions_2.jpg' },
  { id: 'nr_attractions_3', name: 'น้ำตกปาโจ', description: 'น้ำตกขนาดใหญ่ภายในอุทยานแห่งชาติบูโด-สุไหงปาดี มีสายน้ำไหลผ่านผาหินสูง บรรยากาศร่มรื่นด้วยป่าไม้สมบูรณ์', rating: 4.3, type: '📍 สถานที่ท่องเที่ยว', image: '/images/places/nr_attractions_3.jpg' },
  { id: 'nr_attractions_4', name: 'ผานับดาว', description: 'จุดชมวิวทิวทัศน์ทะเลหมอกและดวงดาวในยามค่ำคืน ตั้งอยู่ในอำเภอสุคิริน เหมาะสำหรับสายแคมป์ปิ้งและผู้ที่ชื่นชอบการท่องเที่ยวธรรมชาติ', rating: 4.6, type: '⛰️ จุดชมวิว', image: '/images/places/nr_attractions_4.jpg' },
  { id: 'nr_attractions_5', name: 'พระพุทธทักษิณมิ่งมงคล', description: 'พระพุทธรูปประทับนั่งกลางแจ้งขนาดใหญ่ ประดิษฐานบนยอดเขา เป็นสถานที่ศักดิ์สิทธิ์และจุดแวะสักการะสำคัญของจังหวัด', rating: 4.7, type: '📍 สถานที่ท่องเที่ยว', image: '/images/places/nr_attractions_5.jpg' },
  ...
  { id: 'nr_attractions_7', name: 'เทวสถานองค์พระพิฆเนศ', description: 'ประดิษฐานองค์พระพิฆเนศขนาดใหญ่ในตัวเมืองนราธิวาส เป็นจุดแวะพักผ่อนและสักการะสิ่งศักดิ์สิทธิ์', rating: 4.5, type: '📍 สถานที่ท่องเที่ยว', image: '/images/places/nr_attractions_7.jpg' },
  { id: 'nr_attractions_8', name: 'ศาลเจ้าโก้วเล้งจี่', description: 'ศาลเจ้าเก่าแก่ใจกลางเมืองนราธิวาส มีสถาปัตยกรรมแบบจีนที่สวยงามและประณีต', rating: 4.4, type: '📍 สถานที่ท่องเที่ยว', image: '/images/places/nr_attractions_8.jpg' },
  { id: 'nr_attractions_9', name: 'ตลาดน้ำยะกัง', description: 'ตลาดน้ำย้อนยุคริมคลองยะกัง จำหน่ายอาหารพื้นบ้าน ขนมโบราณมลายู และสินค้าท้องถิ่น', rating: 4.3, type: '📍 สถานที่ท่องเที่ยว', image: '/images/places/nr_attractions_9.jpg' },
];
...
const NARATHIWAT_SOUVENIRS: Place[] = [
  ...
  { id: 'nr_souvenirs_1', name: 'ร้านมุมสุขภาพ นราธิวาส', description: 'ศูนย์รวมของฝาก ผลิตภัณฑ์ OTOP และสินค้าสุขภาพที่ใหญ่แห่งหนึ่งในตัวเมือง จำหน่ายสินค้าแปรรูป ขนมพื้นบ้าน และของใช้จากชุมชนต่างๆ', rating: 4.5, type: '🎁 ร้านของฝาก', image: '/images/places/nr_souvenirs_1.jpg' },
  ...
  { id: 'nr_souvenirs_5', name: 'ตลาดเช้าเทศบาลเมืองนราธิวาส', description: 'ตลาดสดที่มีโซนจำหน่ายของฝากท้องถิ่น เช่น บูดูสำเร็จรูป กะปิแท้ และกรือโป๊ะแบบดิบ เหมาะสำหรับการเดินเลือกซื้อสินค้าราคาเป็นกันเอง', rating: 4.3, type: '📍 ตลาด', image: '/images/places/nr_souvenirs_5.jpg' },
  ...
  { id: 'nr_souvenirs_7', name: 'ศูนย์จำหน่ายสินค้า OTOP จังหวัดนราธิวาส', description: 'ศูนย์รวบรวมผลิตภัณฑ์ชุมชนทั่วทั้งจังหวัดนราธิวาส มีทั้งงานหัตถกรรม ผ้าปาเต๊ะ ผ้าบาติก และอาหารแปรรูป', rating: 4.5, type: '🎁 ร้านของฝาก', image: '/images/places/nr_souvenirs_7.jpg' },
  { id: 'nr_souvenirs_8', name: 'ร้านเครื่องสานกระจูดบ้านทอน', description: 'จำหน่ายกระเป๋าสาน เสื่อกระจูด และของตกแต่งบ้านจากกระจูด ดีไซน์สวยงาม ฝีมือประณีตจากชาวบ้านในพื้นที่', rating: 4.6, type: '🎁 ร้านของฝาก', image: '/images/places/nr_souvenirs_8.jpg' },
  { id: 'nr_souvenirs_9', name: 'ร้านจำหน่ายลองกองและผลไม้ตามฤดูกาล', description: 'บริเวณริมถนนสายหลักช่วงฤดูกาลผลไม้ มีลองกองซีมองนราธิวาสแท้ รสชาติหวานอร่อยเป็นของฝากยอดนิยม', rating: 4.5, type: '🎁 ร้านผลไม้', image: '/images/places/nr_souvenirs_9.jpg' },
];
