...
const places = {
  restaurants: [
    ...
    },
    {
      ...
      rating: 4.7,
      type: '🍽️ ร้านอาหาร',
      image: 'https://mpics.mgronline.com/pics/Images/561000013369401.JPEG'
    },
    {
      id: 'nr_restaurants_4',
      name: 'AKHOO by Nasir',
  ...
  attractions: [
    ...
    },
    {
      ...
      rating: 4.7,
      type: '🕌 มัสยิด',
      image: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/%E0%B8%A1%E0%B8%B1%E0%B8%AA%E0%B8%A2%E0%B8%B4%E0%B8%94%E0%B8%95%E0%B8%B0%E0%B9%82%E0%B8%A5%E0%B8%B0%E0%B8%A1%E0%B8%B2%E0%B9%80%E0%B8%99%E0%B8%B2%E0%B8%B0_%28%E0%B8%A1%E0%B8%B1%E0%B8%AA%E0%B8%A2%E0%B8%B4%E0%B8%94_300_%E0%B8%9B%E0%B8%B5%29.jpg'
    },
    {
      id: 'nr_attractions_3',
      name: 'น้ำตกปาโจ',
    ...
    },
    {
      ...
      rating: 4.5,
      type: '📍 สถานที่ท่องเที่ยว',
      image: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Fishing_Village_in_Narathiwat.jpg'
    },
    {
      id: 'nr_attractions_7',
  ...
  souvenirs: [
    ...
    },
    {
      ...
      rating: 4.9,
      type: '🎁 ร้านของฝาก',
      image: 'https://upload.wikimedia.org/wikipedia/commons/e/ec/Shrimp.paste-Belachan-01.jpg'
    },
    {
      id: 'nr_souvenirs_4',
    ...
    },
    {
      ...
      rating: 4.6,
      type: '🎁 ร้านของฝาก',
      image: 'https://upload.wikimedia.org/wikipedia/commons/6/6c/Lepironia_mucronata.jpg'
    },
    {
      id: 'nr_souvenirs_9',
...
const rCode = formatArr('restaurants', places.restaurants);
const aCode = formatArr('attractions', places.attractions);
const sCode = formatArr('souvenirs', places.souvenirs);
...
console.log('Successfully updated page.tsx with distinct accurate images!');
